                ...
                <div className="banner-img">
                  ...
                  <div className="container">
                    <div className="textOnBanner">
                      <h1 className="fz-100 fz-90--lg lh-1 has-white-color text-center">Interior Design Projects</h1>
                      <div
            ...
            <div className="row service-align-item">
              <div className="col-12">
                <div className="work-list">
                  <h1 className="h1 large-heading sarvice-heading">Interior Design Projects</h1>
                  ...
                  <div className="work-images-middle">
                    <div className="project_items">
                      <img src={process.env.PUBLIC_URL + `/assets/img/root/interior/interior1.jpg`} alt="Sale Image" loading="lazy" />
                    </div>
                    <div className="project_items">
                      <img src={process.env.PUBLIC_URL + `/assets/img/root/services/interior2.jpg`} alt="Sale Image" loading="lazy" />
                    </div>
                    <div className="project_items">
                      <img src={process.env.PUBLIC_URL + `/assets/img/root/services/interior3.jpg`} alt="Sale Image" loading="lazy" />
                    </div>
                    <div className="project_items">
                      <img src={process.env.PUBLIC_URL + `/assets/img/root/services/interior4.jpg`} alt="Sale Image" loading="lazy" />
                    </div>
                    <div className="project_items">
                      <img src={process.env.PUBLIC_URL + `/assets/img/root/interior/interior5.jpg`} alt="Sale Image" loading="lazy" />
                    </div>
                    <div className="project_items">
                      <img src={process.env.PUBLIC_URL + `/assets/img/root/interior/interior6.jpg`} alt="Sale Image" loading="lazy" />
                    </div>
                    <div className="project_items">
                      <img src={process.env.PUBLIC_URL + `/assets/img/root/interior/interior7.jpg`} alt="Sale Image" loading="lazy" />
                    </div>
                    <div className="project_items">
                      <img src={process.env.PUBLIC_URL + `/assets/img/root/interior/interior8.jpg`} alt="Sale Image" loading="lazy" />
                    </div>
                  </div>
