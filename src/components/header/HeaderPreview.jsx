      ...
      <div className="ptf-navbar ptf-navbar--main ptf-navbar--sticky">
        <div className="container-xxl">
          <div className="ptf-navbar-inner">
            ...
            {/* <!--Button--> */}
            <a className="ptf-btn ptf-btn--underlined" href="https://themeforest.net/item/moonex-portfolio-agency-react-template/35431456" target="_self">
              Purchase Now $12
            </a>
          </div>
        </div>
